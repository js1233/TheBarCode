...
import ItemMenuSearch from "ui/components/organisms/item_menu_search/ItemMenuSearch";
...
const MenuSearchView: React.FC<Props> = ({
  data,
    ...
    ({ item }: { item: Venue }) => {
      return (
        <ItemMenuSearch
          ...
          type={ESupportedOrderType.TAKEAWAY_DELIVERY}
        />
      );
    },
    [onItemClicked]
